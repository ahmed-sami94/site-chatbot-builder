...
// Alternative integration example. The public API uses config/chatbot.php by default.
// You can copy this into your app include path if you prefer to manage config there.
